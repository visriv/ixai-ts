...
from src.utils.loading import gen_dataset, save_train_val_pickles
...
def run_single_cfg(this_cfg, base_outdir):
    ...
    pointwise_xai_flag = bool(this_cfg.get("pointwise_xai_flag", True))
    pairwise_xai_flag = bool(this_cfg.get("pairwise_xai_flag", True))
